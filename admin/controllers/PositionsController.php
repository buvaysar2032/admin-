...
/**
 * EmployeesController implements the CRUD actions for Positions model.
 *
...
final class PositionsController extends AdminController
{
    ...
    public function actionCreate(string $redirect = null): Response|string
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            ...
            return match ($redirect) {
                ...
                'index' => $this->redirect(UserUrl::setFilters(PositionsSearch::class)),
    ...
    public function actionDelete(int $id): Response
    {
        ...
        return $this->redirect(UserUrl::setFilters(PositionsSearch::class));
    }
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    private function findModel(int $id): Positions
    {
