...
use common\models\{EmployeesSearch, ExportListSearch, PositionsSearch, TextSearch};
        ...
        [
            ...
            'items' => [
                ...
                [
                    ...
                    'url' => UserUrl::setFilters(EmployeesSearch::class, ['/employees/index'])
                ],
                [
                    'label' => Yii::t('app', 'Positions'),
                    'url' => UserUrl::setFilters(PositionsSearch::class, ['/positions/index'])
                ],
            ]
        ],
        [
